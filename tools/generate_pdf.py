#!/usr/bin/env python3
"""
Cybergrok Automated PDF & HTML Security Report Generator
...
<div class="container">
  ...
  <div class="header-card">
    <div class="brand-tag">Cybergrok Offensive Security Platform</div>
  ...
  <div style="margin-top: 50px; border-top: 1px solid #e2e8f0; padding-top: 15px; font-size: 11px; color: #94a3b8; text-align: center;">
    Generated autonomously by <strong>Cybergrok Security Intelligence</strong> · Confidential Assessment Deliverable
  </div>
</div>
</body>
</html>
