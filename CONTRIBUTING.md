# 🤝 Contributing to Cybergrok

Thank you for your interest in contributing to **Cybergrok**! 
...
git clone https://github.com/<YOUR_USERNAME>/Cybergrok.git
cd Cybergrok
```
...
* Open a PR against the **`dev`** branch of `Grok Build Workforce/Cybergrok`.
...
## 👥 Recognition
All accepted contributors are listed in [`CONTRIBUTORS.md`](CONTRIBUTORS.md) and credited in release changelogs. Thank you for making Cybergrok better!
