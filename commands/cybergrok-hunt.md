---
name: cybergrok-hunt
description: Hunt a specific vulnerability class on an authorized target using Cybergrok playbooks. Use when the user runs /cybergrok-hunt.
...
Only test hosts listed in workspace `scope.yaml`.
